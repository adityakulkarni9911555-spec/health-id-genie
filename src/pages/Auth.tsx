...
export default function Auth() {
  ...
  useEffect(() => {
    ...
    setMeta('link[rel="canonical"]', "href", "https://medorahealthwallet.lovable.app/auth");
    ...
    setMeta('meta[property="og:url"]', "content", "https://medorahealthwallet.lovable.app/auth");
