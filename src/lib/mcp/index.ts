...
export default defineMcp({
  ...
  version: "0.1.0",
  instructions:
    "Tools for managing the Smart Health Card patient database. Use list_patients to browse or search, get_patient for a single record, and register_patient to create a new record.",
